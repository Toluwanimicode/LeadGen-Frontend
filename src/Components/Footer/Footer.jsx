...
const Footer = () => {
  return (
    ...
    <div className="container mx-auto flex flex-col items-center lg:flex lg:flex-row">
      <div className="text-center md:text-left md:mr-16 mb-8 lg:w-1/4">
        <div className="flex justify-center lg:mt-10">
          <a href="#home"><img src="./Images/Newlogo.png" alt="Logo" width="150" height="150" /></a>
        </div>
        ...
        <div className="social mt-12">
          ...
          <a href="#" className="mr-2"><FontAwesomeIcon icon={faGooglePlusG} /></a>
          <a href="#" className="mr-2"><FontAwesomeIcon icon={faPinterest} /></a>
          <a href="#" className="mr-2"><FontAwesomeIcon icon={faLinkedin} /></a>
        </div>
      </div>
      <div className="md:w-full px-4 mb-8 lg:w-1/4">
      ...
      <div className="md:w-full px-4 mb-8 lg:w-1/4 lg:mt-10">
